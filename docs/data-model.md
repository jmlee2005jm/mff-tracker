...
- Character-level CTP is editable from the character header, defaults to empty, and is stored separately from rows as a type plus Regular/Mighty/Brilliant rarity
